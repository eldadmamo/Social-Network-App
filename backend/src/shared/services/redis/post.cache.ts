...
import { BadRequestError, ServerError } from "@root/shared/globals/helpers/error.handler";
    ...
    try{
      ...
      for(const post of replies as IPostDocument[]){
        if(post.imgId && post.imgVersion || post.gifUrl ){
          ...
          post.reactions = Helpers.parseJson(`${post.commentsCount}`) as IReactions;
      ...
      log.error(error);
      throw new BadRequestError('Server error. Try again')
    }
  }
